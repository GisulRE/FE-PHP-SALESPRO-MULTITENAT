...
SQL
            ...
            DB::unprepared('DROP TRIGGER IF EXISTS "AFTER_PRODUCT_PURCHASES_UPDATE_TRIGGER" ON product_purchases;');
            DB::unprepared(<<<'SQL'
CREATE OR REPLACE FUNCTION after_product_purchases_update_trigger_fn()
RETURNS trigger AS $$
DECLARE
    trans_id integer;
...
FOR EACH ROW
EXECUTE FUNCTION after_product_purchases_update_trigger_fn();
SQL
            );
        }
    }
    ...
    public function down()
    {
        ...
        if ($driver === 'mysql') {
            ...
            DB::unprepared('DROP TRIGGER IF EXISTS "AFTER_PRODUCT_PURCHASES_UPDATE_TRIGGER" ON product_purchases;');
            DB::unprepared('DROP FUNCTION IF EXISTS after_product_purchases_update_trigger_fn();');
        }
    }
}
