...
class CreateFacturaMasivaPaquetesTable extends Migration
{
    public function up()
    {
        Schema::create('factura_masiva_paquetes', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedInteger('factura_masiva_id');
    ...
    {
        Schema::dropIfExists('factura_masiva_paquetes');
    }
}
