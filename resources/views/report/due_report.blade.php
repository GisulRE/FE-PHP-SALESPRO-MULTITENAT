...
<section class="forms">
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="col-md-8 offset-md-3 mt-4 mb-3">
                <div class="form-group row">
                    <label class="d-tc mt-2"><strong>{{trans('file.Choose Your Date')}}</strong> &nbsp;</label>
                    <div class="d-tc">
                        <div class="input-group"><input name="start_date" class="form-control" placeholder="DD/MM/YYYY" type="date" value="{{$start_date}}" required>
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="submit" style="margin-left: 5px">{{trans('file.submit')}}</button>
                            </div>
                        </div>
                    </div>
                </div> 
