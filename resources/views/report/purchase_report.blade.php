            ...
            <table id="report-table" class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th>{{ trans('file.reference purchase') }}</th>
                            ...
                            <tr>
                                ...
                                foreach ($product_purchase_data as $product_purchase) {
                                    ...
                                    if ($unit && $unit->operator == '*') {
                                        ...
                                        $purchased_qty += $product_purchase->qty * 1;
                                    }
                                }
                                ?>
                                <td>{{ $purchase_references[$key] }}</td>
                                <td>{{ $product_name[$key] }}</td>
                                <td>{{ number_format((float) $purchase_cost_unit, 2, '.', '') }}</td>
                                <td>{{ $purchased_qty }}</td>
