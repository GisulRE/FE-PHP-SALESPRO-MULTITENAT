...
<section class="forms">
    ...
    <div id="tb_ingresos" class="table-responsive mb-4">
        <h4 style="color: green">INGRESOS</h4>
                        ...
                        @if($ingresosList != null)
                            @foreach($ingresosList as $key=>$paying)
                                ...
                                <tr>
                                    ...
                                    <td class="center">{{ isset($paying[$key1]['reference']) ? $paying[$key1]['reference'] : '-' }}</td>
                                    <td class="center">{{ isset($paying[$key1]['detail']) ? $paying[$key1]['detail'] : '-' }}</td>
        ...
        <table id="total-table" class="table table-hover">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="center" style="font-weight: bold;"><span id="totalingresos">0.00</span></td>
                </tr>
                <tr>
                    <td style="font-weight: bold;"> TOTAL EGRESOS : </td>
                    <td class="center" style="font-weight: bold;"><span id="totalegresos">0.00</span></td>
                </tr>
                <tr>
                    <td style="font-weight: bold;"> TOTAL INGRESOS - EGRESOS : </td>
                    <td class="center" style="font-weight: bold;"><span id="totalgral">0.00</span></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <h5 id="modal_header" class="modal-title">Reporte General</h5>&nbsp;&nbsp;
            ...
            <div id="report_gral" class="modal-body">
                <div id="report_print">
                    <div class="card-header mt-2">
                        <h1 id="title_g">REPORTE GENERAL</h1>
                        ...
                        <p> <span class="bold">Empleado: </span> <span id="biller_print"></span> </p>
                    </div>
                    <h4 id="ing_title" style="color: green">INGRESOS</h4>
                    <div id="tb_ingresos_total" class="table-responsive mb-4"></div>
                    <br><h4 id="egr_title" style="color: red">EGRESOS</h4><br>
...
<script type="text/javascript">
    ...
    $("ul#report #general-report-menu").addClass("active");
    ...
    function consultar(){
        ...
        var url = '<?php echo url('/'); ?>' + '/report/general_report/'+start+'/'+end+'/'+cat+'/'+bill;
    ...
    function print(){
        ...
        var div_2 = $('#egreso-table').clone();
        var div_3 = $('#total-table').clone();
        $('#tb_ingresos_total').html(div_1);
        $('#tb_egresos_detalle').html(div_2);
        $('#tb_totales_ig').html(div_3);
