@extends('layout.main') @section('content')
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header mt-2">
                    <h3 class="text-center">{{ trans('file.Report Attendance By Employee') }}</h3>
                </div>
                <div class="row mb-12">
                            ...
                            <div class="d-tc">
                                <div class="input-group">
                                    <input id="start_date" name="start_date" class="form-control" placeholder="DD/MM/YYYY"
                                        type="date" value="{{ $start_date }}" required onchange="consultar()">
                                    ...
                                    <input id="end_date" name="end_date" class="form-control" placeholder="DD/MM/YYYY"
                                        type="date" value="{{ $end_date }}" required onchange="consultar()">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <table id="report-table" class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th>{{ trans('file.Time Late') }} (Horas)</th>
                    </tr>
                </thead>
                <tbody>
                    @if (!empty($lims_attendances))
                        @foreach ($lims_attendances as $key => $attendance)
                            @php
                            ...
                            <tr>
                                ...
                                <td>{{ $attendance->checkout == null ? 'No Registro' : $attendance->checkout }}</td>
                                ...
                                @endif
                                <td>{{ number_format($attendance->hours, 2) }}</td>
                            </tr>
                        @endforeach
                    @endif
                </tbody>
    ...
    <script type="text/javascript">
        ...
        function consultar() {
            ...
            var url = '<?php echo url('/'); ?>' + '/report/attendance-employee/' + dates + '/' + datee + "/" + user_id;
