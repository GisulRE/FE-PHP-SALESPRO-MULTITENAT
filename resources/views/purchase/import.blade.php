                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <p>{{trans('file.The correct column order is')}} (codigo, Cantidad, Unidad, Precio, Lote_Exp) {{trans('file.and you must follow this')}}. {{trans('file.All columns are required')}}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
