            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>Actualizar Autorización Facturación</h4>
                    </div>
                    
                    <div class="card-body">
                        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        <form action="{{ route('autorizacion.update', $item['idautorizacion']) }}" method="POST">
                            @method('PUT')
                            @csrf 
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select id="tipo_modalidad" name="tipo_modalidad" title="Seleccionar..." onchange="buscarDocumentoSector();" class="form-control selectpicker" required>
                                                    <option value="1" {{ $item['tipo_modalidad'] == '1' ? 'selected="selected"' : '' }}>ELECTRONICA </option>
                                                    <option value="2" {{ $item['tipo_modalidad'] == '2' ? 'selected="selected"' : '' }}>COMPUTARIZADA</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select id="tipo_ambiente" name="tipo_ambiente" title="Seleccionar..." onchange="buscarDocumentoSector();" class="form-control selectpicker" required>
                                                    <option value="1" {{ $item['ambiente'] == '1' ? 'selected="selected"' : '' }}>Producción </option>
                                                    <option value="2" {{ $item['ambiente'] == '2' ? 'selected="selected"' : '' }}>Pruebas</option>
                                                </select>                                                
                                            </div>
                                        </div>
                                    </div>                                    
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="list_documento_sector" class="d-flex flex-column">
                                                ...
                                                <div class="form-check form-check-inline"> 
                                                    <input class="form-check-input" checked type="checkbox" name="documento_sector[]" value="{{$doc['codigo_sin']}}">
                                                    <label class="form-check-label">{{$doc['descripcion_sin']}}</label> 
                                                </div>
                                                @endforeach
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            ...
                                            <div id="list_urls" class="d-flex flex-column">
                                                @foreach ($documentos as $data_url)
                                                <div class="form-check form-check-inline"> 
                                                    <label class="form-check-label">{{$data_url['url']}}</label> 
                                                </div>
                                                @endforeach
                                            </div>
                                        </div>
                                ...
                                <div class="row col-12">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="fecha_solicitud" id="fecha_solicitud" value="{{$item['fechaSolicitud']}}" class="form-control" required> 
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="tipo_sistema" class="form-control selectpicker" required>
                                                    <option value="PROPIO" {{ $item['tipo_sistema'] == 'PROPIO' ? 'selected="selected"' : '' }}>Propio</option>
                                                    <option value="PROVEEDOR" {{ $item['tipo_sistema'] == 'PROVEEDOR' ? 'selected="selected"' : '' }}>Proveedor</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="codigo_sistema" id="codigo_sistema" value="{{$item['codigo_sistema']}}" class="form-control" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="token" id="token" rows="10" required>{{$item['token']}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="fecha_vencimiento_token" id="fecha_vencimiento_token" value="{{$item['fecha_vencimiento_token']}}" class="form-control" required> 
                                        </div>
                                    </div>                            
