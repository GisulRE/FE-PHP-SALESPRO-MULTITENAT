...
<div class="container-fluid">
  <div class="row">
    <div class="col sidebar mb-3">
      <?php $datos_generales = DB::table('general_settings')->latest()->first(); ?>
      <h1><img src="{{ url('public/logo', $general_setting->site_logo) }}"
        width="50"> {{ $datos_generales->site_title }}</h1>
      <p class="text-muted"><i>Desarrollado por Gisul S.R.L.</i></p>
