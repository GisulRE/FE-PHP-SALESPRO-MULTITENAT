@extends('layout.top-head') @section('content')
    ...
    <script type="text/javascript">
        ...
        $("#submit-btn").on("click", function(e) {
            ...
            // 1) Si estamos en primer paso -> crear venta en modo preview via AJAX y mostrar imprimible
                ...
                $.post('{{ url("sales/finalize-ajax") }}', finalizeData)
                    .done(function(res) {
                        ...
                        if (res.status) {
                            ...
                            if (res.print_url) {
                                // Cargar el contenido de la factura dentro del modal
                                $.get(res.print_url, function(html) {
                                    $('#final_print_container').html(html);
                                }).fail(function() {
                                    // Si falla, mostrar link para abrir en nueva ventana
                                ...
                                // También habilitar el link por si el usuario quiere abrirlo en nueva ventana
