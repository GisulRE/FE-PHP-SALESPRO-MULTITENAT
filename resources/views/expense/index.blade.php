                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                        ...
                                        @if (in_array('expenses-edit', $all_permission))
                                            <li><button type="button" data-id="{{ $expense->id }}"
                                                    ...
                                                    onclick="openDialog('{{ $expense->id }}')" data-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            <label>{{ trans('file.Date') }} <small>(Fecha de Gasto)</small></label>
                            <input id="date_expense" type="date" name="date_expense" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function openDialog(idp) {
            ...
            $.get(url, function(data) {
                ...
                $("#editModal input[name='date_expense']").val(currentDate);
