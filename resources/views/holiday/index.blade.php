@extends('layout.main') @section('content')
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary btn-edit"
                                        ...
                                        data-from="{{ date('Y-m-d', strtotime($holiday->from_date)) }}"
                                        data-to="{{ date('Y-m-d', strtotime($holiday->to_date)) }}"
                                        data-note="{{ $holiday->note }}" data-employee="{{ $holiday->user_id }}" data-toggle="modal" data-target="#editModal"><i
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <select name="employee_id" class="selectpicker form-control" required data-live-search="true"
                                data-live-search-style="contains" title="Seleccione Empleado...">
                                @foreach ($lims_employee_all as $employee)
    ...
    <script type="text/javascript">
        ...
        $('.btn-edit').on('click', function() {
            ...
            $("select[name='employee_id']").val($(this).data('employee'));
                ...
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        ...
                        if (holiday_id.length && confirm("Are you sure want to delete?")) {
                            ...
                            swal("Error", "No hay registros seleccionados!", "error");
                    }
                },
                {
                    extend: 'colvis',
