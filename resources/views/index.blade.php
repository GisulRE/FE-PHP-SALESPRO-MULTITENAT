...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="wrapper count-title text-center">
                                <div class="icon"><i class="dripicons-weight" style="color: #297ff9"></i></div>
                                <div class="name"><strong style="color: #29f93a">{{ trans('file.cost') }}</strong></div>
                                <div class="count-number cost-data">{{ number_format((float) $cost, 2, '.', ',') }}</div>
                            </div>
                        </div>
                        <!-- Count item widget-->
                        <div class="col-sm-4">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($yearly_best_selling_price as $key => $sale)
                                        ...
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $product!=null?$product->name:'Producto Eliminado' }}<br>[{{ $product!=null?$product->code:'Desconocido' }}]</td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            var start_date = "{{ date('Y') . '-' . date('m') . '-' . '01' }}";
            ...
            function dashboardFilter(data) {
                $('.revenue-data').hide();
                $('.revenue-data').html(formatNumber(data[0]));
                $('.revenue-data').show(500);

                $('.return-data').hide();
                $('.return-data').html(formatNumber(data[1]));
                $('.return-data').show(500);

                $('.profit-data').hide();
                $('.profit-data').html(formatNumber(data[2]));
                $('.profit-data').show(500);

                $('.cost-data').hide();
                $('.cost-data').html(formatNumber(data[4]));
                $('.cost-data').show(500);

                $('.purchase_return-data').hide();
                $('.purchase_return-data').html(formatNumber(data[3]));
