                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="percentage" required="required" class="form-control">
                        </div>
                        <div class="form-group">
    ...
    <script type="text/javascript">
                ...
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        ...
                        if (customer_group_id.length && confirm("Are you sure want to delete?")) {
                            ...
                            swal("Mensaje", "Nose se selecciono un grupo de cliente o más!", "info");
                    }
                },
                {
                    extend: 'colvis',
        ...
        $("#export").on("click", function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    swal("Mensaje", "Exportado a CSV exitosamente! Click Ok para descargar el archivo" + data, "success");
