        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>{{ trans('file.Phone Number') }} * (A este número se enviaran
                            notificaciones de Whatsapp)</label>
                    ...
                    <div class="form-group">
                        ...
                        <select name="sucursal_id" id="sucursal_id" class="form-control" title="Seleccionar sucursal...">
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Sucursal </label>
                        <select name="sucursal_id" id="sucursal_id" class="form-control selectpicker">
                            @foreach ($sucursales as $item)
                                <option value="{{ $item->id }}">{{ $item->nombre }} | {{ $item->telefono }}</option>
                            @endforeach
                        </select>
        ...
        $(document).ready(function () {
            ...
            $('.open-EditWarehouseDialog').on('click', function () {
                ...
                $.get(url, function (data) {
                    ...
                    $("#editModal input[name='sucursal_id']").val(data['sucursal_id']);
