@extends('layout.main') @section('content')
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    <li>
                                                        <a href="{{ url('transfers/' . $transfer->id . '/details') }}" class="btn btn-link">
    ...
    <script type="text/javascript">
        ...
        $("ul#transfer #transfer-request-menu").addClass("active");
        ...
        $('#transfer-table').DataTable({
            "order": [],
            'language': {
                'lengthMenu': '_MENU_ {{ trans('
                        file.records per page ') }}',
        "info": '<small>{{ trans('
                        file.Showing ') }} _START_ - _END_(_TOTAL_)</small > ',
        "search": '{{ trans('
                        file.Search ') }} ',
        'paginate': {
        ...
        function transferDetails(transfer) {
            var htmltext = '<strong>{{ trans('
                    file.Date ') }}: </strong > ' + transfer[0] +
            '<br><strong>{{ trans('
                    file.reference ') }}: </strong > ' + transfer[1] +
            '<br><strong> {{ trans('
                    file.Transfer ') }} {{ trans('
                    file.Status ') }}: </strong > ' + transfer[2] +
            '<br><br><div class="row"><div class="col-md-6"><strong>{{ trans('
                    file.From ') }}:</strong > <br>' + transfer[
                4] + '<br>' + transfer[5] + '<br>' + transfer[6] +
                    '</div><div class="col-md-6"><div class="float-right"><strong>{{ trans('
                    file.To ') }}:</strong><br>' +
                        ...
                        var newBody = $("<tbody>");
                            ...
                            var newRow = $("<tr>");
                                ...
                                var newRow = $("<tr>");
                                    cols = '';
                                    cols += '<td colspan=4><strong>{{ trans('
                        file.Total ') }}:</strong></td>';
                                ...
                                var newRow = $("<tr>");
                                    cols = '';
                                    cols += '<td colspan=5><strong>{{ trans('
                        file.Shipping Cost ') }}:</strong></td>';
                        ...
                        file.grand total ') }}:</strong></td>';
                                ...
                                var htmlfooter = '<p><strong>{{ trans('
                    file.Note ') }}:</strong> ' + transfer[14] +
                                    '</p><strong>{{ trans('
                    file.Created By ') }}:</strong><br>' + transfer[15] + '<br>' + transfer[16];
