                    ...
                    @foreach ($lims_stock_count_all as $key => $stock_count)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <div class="badge badge-primary finalize" data-id="{{ $stock_count->id }}">
                                        {{ trans('file.Finalize') }}
                                    </div>
                                @endif
                            </td>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.final-report').on('click', function() {
                ...
                $.get('stock-count/stockdif/' + stock_count[8], function(data, textStatus, xhr) {
                    ...
                    if (name_code) {
                        ...
                        $.each(name_code, function(index) {
                            ...
                            cols += '<td>' + parseFloat(expected[index]).toFixed(2) +
                                '</td>';
                            cols += '<td>' + parseFloat(counted[index]).toFixed(2) +
                            '</td>';
                        ...
                        if (!parseInt(data[5])) {
                            htmlFooter =
                                '<a class="btn btn-primary d-print-none" href="stock-count/' +
                                stock_count[8] +
                    ...
                    if (data.status == 500)
                        swal('Error en datos o servidor!',
                            "No se pudo procesar lista, contacte con soporte",
                            "error");
                });
