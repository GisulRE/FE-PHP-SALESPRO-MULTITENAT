...
@section('content')
    ...
    <section>
        @if (in_array('qty_adjustment-add', $all_permission))
            <div class="container-fluid">
                <a href="{{ route('qty_adjustment.create') }}" class="stopReload_out btn btn-info"><i
            ...
            <table id="adjustment-table" class="table purchase-list">
                <thead>
                    <tr>
                        ...
                        <th style="width: 15% !important;">{{ trans('file.reference') }}</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
                    ...
                    },
                    {
                        ...
                        action: function(e, dt, node, config) {
                            ...
                            if (adjustment_id.length && confirm("Are you sure want to delete?")) {
                                ...
                                swal('Error!', "No hay datos seleccionados!", "error");
                        }
                    },
                    {
                        extend: 'colvis',
            ...
            if (all_permission.indexOf("qty_adjustment-delete") == -1)
