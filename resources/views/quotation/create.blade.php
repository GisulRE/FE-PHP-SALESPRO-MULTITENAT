@extends('layout.main') @section('content')
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select required name="biller_id" class="selectpicker form-control"
                                                    data-live-search="true" id="biller-id" data-live-search-style="begins"
                                                    title="{{ trans('file.Select Biller...') }}">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>{{ trans('file.date_valid') }} (Opcional)</label>
                                                <input type="date" id="valid_date" class="form-control" name="valid_date"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="customer_name" id="lims_customerSearch"
                                                    placeholder="Buscar por Nombres/Apellidos/Numero Documento"
                                                    class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <div class="search-box input-group">
                                                <button type="button" id="product-code-btn" class="btn btn-secondary" onclick="$('#lims_productcodeSearch').focus();"><i class="fa fa-barcode"></i></button>
    ...
    <script type="text/javascript">
        ...
        $('select[name="warehouse_id"]').on('change', function() {
            ...
            $.get('/quotations/getproduct/' + id + '/' + customer_id, function(data) {
                lims_product_array = [];
                product_code = data[0];
                product_name = data[1];
                product_qty = data[2];
        ...
        // Forzar carga inicial si ya hay un almacén seleccionado (evita que lims_product_array quede vacío)
        ...
        var lims_customerSearch = $('#lims_customerSearch');
         ...
         lims_customerSearch.autocomplete({
             ...
             .autocomplete("instance")._renderItem = function(ul, item) {
                 var doc = '';
                 if (item.valor_documento && item.valor_documento != '0') doc = item.valor_documento;
                 else if (item.codigofijo && item.codigofijo != '0') doc = item.codigofijo;
                 else if (item.nro_medidor && item.nro_medidor != '0') doc = item.nro_medidor;
                 return $("<li>")
                     .append("<div>" + item.name + (doc ? ' - ' + doc : '') + " </div>")
                     .appendTo(ul);
             };
        ...
        $('#quotation-form').on('submit', function(e) {
            ...
            if (rownumber < 0) {
                swal("Información", "Por favor ingrese un producto en la tabla de orden!", "info");
                e.preventDefault();
            }
        });
