@extends('layout.main') @section('content')
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="valid_date" class="form-control" name="valid_date"
                                                    value="{{ $lims_quotation_data->valid_date }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="customer_name" id="lims_customerSearch"
                                                    value="{{ $lims_quotation_data->customer->name }}"
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <label>{{ trans('file.Select Product') }}</label>
                                                ...
                                                <button type="button" id="product-code-btn" class="btn btn-secondary btn-lg" onclick="$('#lims_productcodeSearch').focus();"><i
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($lims_product_quotation_data as $product_quotation)
                                                            <tr>
                                                                ...
                                                                <td class="tax">
                                                                    {{ number_format((float) $product_quotation->tax, 2, '.', '') }}
                                                                </td>
                                                                <td class="sub-total">
    ...
    <script type="text/javascript">
        ...
        // Forzar carga inicial si ya hay un almacén seleccionado (poblar lims_product_array)
