...
<section>
            ...
            <table id="product-table" class="table">
                ...
                <tbody>
                    ...
                    <tr data-id="{{$documento->id}}">
                        ...
                        <td>{{ $documento->getDescripcionDocumento() }}</td>
                        <td>{{ $documento->getSucursal->nombre }}</td>
                        <td>{{ $documento->getPuntoVenta->nombre_punto_venta }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
    ...
    <script>
        $("ul#nav-siat #doc").addClass("active");
        ...
        function onSelectBiller() {
            ...
            //Petición AJAX
            $('#btnBuscar').prop('href','{{ url("siat_panel/doc")}}' + '/' + biller_id );
