...
<section>
            ...
            <table id="product-table" class="table">
                ...
                <tbody>
                    ...
                    <tr data-id="{{$actividad->id}}">
                        ...
                        <td>
                            @if ($actividad->tipo_actividad == 'P')
                                Producto                                
                            @else
                                Servicio
                            @endif
                        </td>
                        <td>{{ $actividad->getSucursal->nombre }}</td>
                        <td>{{ $actividad->getpuntoventa->nombre_punto_venta }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
    ...
    <script>
        $("ul#nav-siat #act").addClass("active");
        ...
        function onSelectBiller() {
            ...
            //Petición AJAX
            $('#btnBuscar').prop('href','{{ url("siat_panel/act")}}' + '/' + biller_id );
