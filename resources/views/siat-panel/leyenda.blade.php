...
<section>
            ...
            <table id="product-table" class="table">
                ...
                <tbody>
                    ...
                    <tr data-id="{{$leyenda->id}}">
                        ...
                        <td>{{ $leyenda->getSucursal->nombre }}</td>
                        <td>{{ $leyenda->getPuntoVenta->nombre_punto_venta }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
    ...
    <script>
        $("ul#nav-siat #ley").addClass("active");
        ...
        function onSelectBiller() {
            ...
            //Petición AJAX
            $('#btnBuscar').prop('href','{{ url("siat_panel/leyenda")}}' + '/' + biller_id );
