                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select required name="customer_id" class="selectpicker form-control"
                                                    data-live-search="true" id="customer_id" data-live-search-style="contains"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select required id="warehouse_id" name="warehouse_id"
                                                    ...
                                                    data-live-search-style="begins" title="Selecciones Almacen...">
                                        ...
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <div class="search-box input-group">
                                                ...
                                                <input type="text" name="product_code_name" id="lims_productcodeSearch"
                                                    placeholder="Por favor escriba para buscar por nombre/codigo..."
                                                    class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="table-responsive mt-3">
                                                <table id="myTable" class="table table-hover order-list">
                                                    ...
                                                    <tfoot class="tfoot active">
                                                        ...
                                                        <th id="total">
                                                            {{ number_format((float) $lims_return_data->total_price, 2, '.', '') }}
                                                        </th>
                                                        <th><i class="dripicons-trash"></i></th>
                                                    </tfoot>
                                                </table>
    ...
    <script type="text/javascript">
        ...
        $("#myTable").on('input', '.qty', function() {
            ...
            if ($(this).val() < 1 && $(this).val() != '') {
                ...
                swal("Error", "Cantidad no puede ser menor que 1", "error");
            }
