@extends('layout.main') @section('content')
    ...
    <section class="forms">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if ($modo_factura)
                                <div class="row">
                                    <div class="card-header d-flex align-items-center">
                                        <h4>Datos de la Factura Original</h4>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    ...
                                                    <p>&nbsp; {{ $factura['numeroDocumento'] }}</p>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <label>Nombre/Razón Social: </label>
                                                    <p>&nbsp; {{ $factura['nombreRazonSocial'] }}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    ...
                                                    <p>&nbsp; {{ date('d/m/Y H:i:s', strtotime($factura['fechaEmision'])) }}
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                @if ($modo_factura)
                                                    ...
                                                    <input type="hidden" name="cuf" value="{{ $factura['cuf'] }}" />
                                                    <input type="hidden" name="sale_id" value="{{ $sale->id }}" />
                                                @endif
                                                <select required name="customer_id" id="customer_id"
                                                    class="selectpicker form-control" data-live-search="true"
                                                    id="customer-id" data-live-search-style="contains"
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-md-12">
                                            ...
                                            <div class="table-responsive mt-3">
                                                @if ($modo_factura)
                                                    <div id="info-alert" class="alert-info alert-dismissible fade show"
                                                        role="alert">
                                                        <strong id="info-alert"
                                                            class="alert-info alert-dismissible fade show" role="alert">
                                                            <strong>Guia: </strong> Borrar los items que no se van a
                                                            retornar.
                                                        </strong>
                                                    </div>
                                                @endif
                                                ...
                                                <table id="myTable" class="table table-hover order-list">
                                                    ...
                                                    <tbody>
                                                        @if ($modo_factura)
                                                            ...
                                                            ?>
                                                            @foreach ($list_saleitems as $product_return)
                                                                <tr>
                                                                    <?php
                                                                    ...
                                                                    <td><input type="number" class="form-control qty"
                                                                            name="qty[]"
                                                                            value="{{ $product_return->qty }}" required
                                                                            step="any" /></td>
                                                                    ...
                                                                    <input type="hidden" class="sale-unit-operator"
                                                                        value="{{ $unit_operator }}" />
                                                                    <input type="hidden"
                                                                        class="sale-unit-operation-value"
                                                    ...
                                                    <tfoot class="tfoot active">
                                                        @if ($modo_factura)
                                                            ...
                                                            <th id="total-tax">
                                                                {{ number_format((float) $sale->total_tax, 2, '.', '') }}
                                                            </th>
                                                            <th id="total">
                                    ...
                                    <div class="form-group">
                                        @if ($modo_factura)
                                            <input type="hidden" name="nombreRazonSocial"
                                                value="{{ $factura['nombreRazonSocial'] }}">
                                            <input type="hidden" name="numeroDocumento"
                                                value="{{ $factura['numeroDocumento'] }}">
                                            <input type="hidden" name="complemento"
                                                value="{{ $factura['complemento'] }}">
                                            <input type="hidden" name="codigoTipoDocumentoIdentidad"
                                                value="{{ $factura['codigoTipoDocumentoIdentidad'] }}">
        ...
        @if ($modo_factura)
            <div id="confirmarModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Nombre/Razón Social</label>
                                        <input type="text" name="edit_razonSocial" class="form-control"
                                            value="{{ $factura['nombreRazonSocial'] }}" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Tipo Documento</label>
                                        <select required name="tipo_documento" class="selectpicker form-control"
                                            data-live-search="true" data-live-search-style="begins"
                                            title="Seleccione documento..." >
                                            @foreach ($lims_tipodocumentos as $documento)
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Número Documento/NIT</label>
                                        <input type="text" name="edit_valueDocumento" class="form-control"
                                            value="{{ $factura['numeroDocumento'] }}" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <label>Complemento</label>
                                        <input type="text" name="edit_complemento" class="form-control"
                                            value="{{ $factura['complemento'] }}">
                                    </div>
                                </div>
                                <div class="col-4">
                            ...
                            <button id="submit_btn" type="button" name="submit_btn"
    ...
    <script type="text/javascript">
        ...
        var modofactura = <?php echo json_encode($modo_factura); ?>;
        ...
        if (modofactura) {
            ...
            $('select[name="tipo_documento"]').val({{isset($lims_customer_data->tipo_documento)}});
            $('select[name="warehouse_id"]').addClass('noselect');
            $('select[name="biller_id"]').addClass('noselect');
            $('select[name="customer_id"]').addClass('noselect');
            //$('select[name="order_tax_rate"]').val(13);

            $.get('getcustomergroup/' + $('select[name="customer_id"]').val(), function(data) {
                customer_group_rate = (data / 100);
            });

            $.get('getproduct/' + $('select[name="warehouse_id"]').val(), function(data) {
                lims_product_array = [];
                product_code = data[0];
                product_name = data[1];
                product_qty = data[2];
        ...
        $('#lims_productcodeSearch').on('input', function() {
            ...
            if (!customer_id) {
                ...
                $('#lims_productcodeSearch').val(temp_data.substring(0, temp_data.length - 1));
                swal("Error", "Por favor seleccione un Almacen!", "error");
            }
        });
        ...
        $("#myTable").on('input', '.qty', function() {
            ...
            if ($(this).val() < 1 && $(this).val() != '') {
                ...
                swal("Error", "La cantidad no puede ser menor que 1", "error");
            }
            var max_cant = $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.cantotal-value')
                .val();
            if ($(this).val() > max_cant) {
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ') .qty').val(max_cant);
                swal("Error", "La cantidad no puede ser mayor que " + max_cant, "error");
            }
        ...
        $('button[name="update_btn"]').on("click", function() {
            ...
            if (parseFloat(edit_discount) > parseFloat(edit_unit_price)) {
                swal("Error", "Entrada de descuento invalido!", "error");
                return;
            }
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (flag) {
                        ...
                        cols += '<input type="hidden" class="product-price" name="product_price[]" />';
        ...
        function calculateRowProductData(quantity) {
            ...
            if (tax_method[rowindex] == 1) {
                ...
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find(
                    '.product-price').val(net_unit_price.toFixed(2));
            } else {
                ...
                var price_proiva = net_unit_price + iva;
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(4)').text(net_unit_price
                    .toFixed(2));
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.net_unit_price').val(net_unit_price
                    .toFixed(2));
                ...
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.subtotal-value').val(sub_total
                    .toFixed(2));
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find(
                    '.product-price').val(price_proiva.toFixed(2));
            }
        ...
        $("#submit-button").on("click", function() {
            var rownumber = $('table.order-list tbody tr:last').index();
            if (rownumber < 0) {
                swal("Mensaje", "Por favor ingrese un producto en la tabla!", "info");
                e.preventDefault();
            }
        ...
        $("#submit_btn").on("click", function() {
            if ($('input[name="edit_razonSocial"]').val() == null || $('input[name="edit_razonSocial"]').val() ==
                '') {
                swal("Error", "Por favor ingrese una Razon Social!", "error");
                return;
            }
            if ($('input[name="edit_valueDocumento"]').val() == null || $('input[name="edit_valueDocumento"]')
                .val() ==
                '') {
                swal("Error", "Por favor ingrese un Numero Documento/NIT!", "error");
                return;
            }
            if ($('select[name="tipo_documento"]').val() == null || $('select[name="tipo_documento"]')
                .val() ==
                '') {
                swal("Error", "Por favor seleccione un tipo de documento!", "error");
                return;
            }
            if ($('input[name="edit_email"]').val() == null || $('input[name="edit_email"]')
                .val() ==
                '') {
                swal("Error", "Por favor ingrese una direccion de correo electronico!", "error");
                return;
            }
            $('input[name="nombreRazonSocial"]').val($('input[name="edit_razonSocial"]').val());
            $('input[name="numeroDocumento"]').val($('input[name="edit_valueDocumento"]').val());
            $('input[name="complemento"]').val($('input[name="edit_complemento"]').val());
            $('input[name="codigoTipoDocumentoIdentidad"]').val($('select[name="tipo_documento"]').val());
            $('input[name="email"]').val($('input[name="edit_email"]').val());
            $('.payment-form').submit();
        });
    </script>
@endsection('content')
