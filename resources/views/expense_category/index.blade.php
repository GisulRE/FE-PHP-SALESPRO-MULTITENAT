@extends('layout.main') @section('content')
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            {{ Form::text('code', null, ['required' => 'required', 'class' => 'form-control', 'placeholder' => 'Type expense category code...']) }}
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('name', null, ['required' => 'required', 'class' => 'form-control', 'placeholder' => 'Type expense category name...']) }}
                    </div>
    ...
    <div id="importExpenseCategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="italic">
                        <small>{{ trans('file.The field labels marked with * are required input fields') }}.</small></p>
                    <p>{{ trans('file.The correct column order is') }} (code*, name*)
