@extends('layout.main') @section('content')
    ...
    <section>
        <div class="container-fluid">
            <button class="btn btn-info" data-toggle="modal" onclick="openDialogNew()" data-target="#account-modal"><i
                    ...
                    @foreach ($lims_account_all as $key => $account)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <input type="checkbox" class="default" data-id="{{ $account->id }}"
                                        data-toggle="toggle" data-onstyle="success" data-offstyle="danger">
                                @endif
                            </td>
                            <td>{{ $account->note }}</td>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                        user="menu">
                                        <li><button type="button" data-id="{{ $account->id }}"
                                                class="edit-btn btn btn-link" onclick="openDialog('{{ $account->id }}')"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" style="display: none">
                        ...
                        <select class="selectpicker form-control" name="methodpays[]" id="methodpays"
    ...
    <script type="text/javascript">
        ...
        function openDialog(idp) {
            ...
            $.get(url, function(data) {
                ...
                $("input[name='account_no']").val(data['account']['account_no']);
                $("textarea[name='note']").val(data['account']['note']);
                $("input[name='name']").val(data['account']['name']);
                $("input[name='initial_balance']").val(data['account']['initial_balance']);
                $("select[name='type']").val(data['account']['type']);
                addOptions("methodpays", data['list_method']);

                var listsel = data['methods'];
                for (value in listsel) {
                    $("#methodpays option[value='" + listsel[value].methodpay_id + "']").prop("selected", true);
                }
