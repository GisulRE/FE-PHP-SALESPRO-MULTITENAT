...
@section('content')
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="type" required class="form-control selectpicker"
                                                    ...
                                                    <option value="digital">Digital/Servicio</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="code" id="code" minlength="1"
                                                    value="{{ $lims_product_data->code }}" class="form-control" required
                                                    title="1 caracteres minimo">
                                    ...
                                    <div id="combo" class="col-md-9 mb-1">
                                        ...
                                        <div class="search-box input-group mb-3">
                                            ...
                                            @if ($lims_product_data)
                                                <input class="mt-2" type="checkbox" name="saveprice"
                                                    value="{{ $lims_product_data->is_pricelist }}"
                                                    @if ($lims_product_data->is_pricelist == 1) checked @endif>
                                            @endif
                                            <label class="mt-2"> &nbsp;<strong>{{ trans('file.saveprice') }}</label>
                                        </div>
                                                        ...
                                                        @foreach ($product_list as $key => $id)
                                                            <tr>
                                                                @php
                                                                    ...
                                                                    if ($lims_product_data->is_pricelist) {
                                                                        $price = $price_list[$key];
                                                                    } else {
                                                                        $price = $product->price;
                                                                    }
                                                                    if ($product->sale_unit_id != 0) {
                                                                        $unit = \App\Unit::find($product->sale_unit_id);
                                                                        if ($unit != null && $unit->operator == '*') {
                                                                            $price = $price / $unit->operation_value;
                                                                        } elseif ($unit != null && $unit->operator == '/') {
                                                                            $price = $price * $unit->operation_value;
                                                                        }
                                    ...
                                    <div id="pro_terminado" class="col-md-9 mb-1">
                                        <label>{{ trans('file.add_product') }}</label>
                                        <div class="search-box input-group mb-3">
                                            <button class="btn btn-secondary"><i class="fa fa-barcode"></i></button>
                                            <input type="text" name="product_code_name_insumo"
                                                id="lims_productcodeSearchInsumo"
                                                placeholder="Escriba el código del producto y seleccione..."
                                                class="form-control" />
                                        </div>
                                        <label>{{ trans('file.Insumo Products') }}</label>
                                        <div class="table-responsive">
                                            <table id="myTableIns" class="table table-hover">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 280px;">{{ trans('file.product') }}</th>
                                                        <th>{{ trans('file.Unit') }}</th>
                                                        <th>{{ trans('file.Quantity') }}</th>
                                                ...
                                                <tbody>
                                                    @if ($lims_product_data->type == 'producto_terminado')
                                                        @php
                                                            $product_list = explode(',', $lims_product_data->product_list);
                                                            $qty_list = explode(',', $lims_product_data->qty_list);
                                                            $price_list = explode(',', $lims_product_data->price_list);
                                                        ...
                                                        @foreach ($product_list as $key => $id)
                                                            <tr>
                                                                @php
                                                                    $product = \App\Product::find($id);
                                                                    $unit = \App\Unit::select('id', 'unit_code')->find($product->sale_unit_id);
                                                                @endphp
                                                                <td>{{ $product->name }} [{{ $product->code }}]</td>
                                                                <td>{{ $unit->unit_code }}</td>
                                                                <td><input type="number" class="form-control qty"
                                                                        name="product_qty[]"
                                                                        value="{{ $qty_list[$key] }}" step="any">
                                                                </td>
                                                                <td><input type="number" class="form-control unit_price"
                                                                        name="unit_price[]" value="{{ $product->cost }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" 
                                                       ...
                                                       data-toggle="modal" 
                                                       data-target="#categorySearchModal"
                                                       value="{{ $lims_product_data->category->name ?? '' }}">
                                                <select name="category_id" 
                                                    ...
                                                    @foreach ($lims_category_list as $category)
                                                        <option value="{{ $category->id }}"
                                                            {{ $category->id == $lims_product_data->category_id ? 'selected' : '' }}>
                                                            {{ $category->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    {{-- formulario para homologación siat --}}
                                    @include('product.partials-actividad-productos-servicios-edit')
                                    {{-- formulario para homologación siat --}}
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <select required class="form-control selectpicker"
                                                        data-live-search="true" data-live-search-style="begins"
                                                        title="Seleccionar unidad..." name="unit_id">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{ trans('file.Product Price') }} por defecto *</strong> </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{ trans('file.Product Price') }} A</strong> </label>
                                            <input type="number" name="price_a"
                                                value="{{ $lims_product_data->price_a }}" class="form-control"
                                                step="any">
                                            <span class="validation-msg"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{ trans('file.Product Price') }} B</strong> </label>
                                            <input type="number" name="price_b"
                                                value="{{ $lims_product_data->price_b }}" class="form-control"
                                                step="any">
                                            <span class="validation-msg"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{ trans('file.Product Price') }} C</strong> </label>
                                            <input type="number" name="price_c"
                                                value="{{ $lims_product_data->price_c }}" class="form-control"
                                                step="any">
                                            <span class="validation-msg"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div id="commission" class="col-md-4">
                                        <div class="form-group">
                                            <label>{{ trans('file.Product Commission') }} %</strong> </label>
                                            <input type="number" name="commission_percentage" class="form-control"
                                                step="any" value="{{ $lims_product_data->commission_percentage }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="hidden" name="account"
                                                value="{{ $lims_product_data->account_id }}">
                                            <label>Cuenta Contable</strong> </label>
                                            <select name="account_id" class="form-control selectpicker" data-live-search="true" data-live-search-style="contains">
                                    ...
                                    <div id="basicservice" class="col-md-4">
                                        <div class="form-group mt-3">
                                            @if ($lims_product_data->is_basicservice)
                                                <input type="checkbox" name="is_basicservice" value="1" checked>
                                            @else
                                                <input type="checkbox" name="is_basicservice" value="1">
                                            @endif
                                            <label>{{ trans('file.basicservice') }}</label>
                                            <p class="italic"> El producto sera tipo servicio basico</p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4 mt-2">
                                        <input type="hidden" name="courtesy_hidden"
                                            value="{{ $lims_product_data->courtesy }}">
                                        <input name="courtesy" type="checkbox" id="courtesy" value="TRUE">&nbsp;
                                        <label>
                                            <h5> {{ trans('file.enable courtesy') }}</h5>
                                        </label>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="row mb-3">
                                            <div class="col-md-4" id="permanent">
                                                <div class="form-group">
                                                    <label>{{ trans('file.permanent') }}</label>
                                                    <div class="input-group">
                                                        <select name="permanent" class="form-control selectpicker">
                                                            <option disabled>Seleccione</option>
                                                            <option value="TRUE">Si</option>
                                                            <option value="FALSE">No</option>
                                                        </select>
                                                        <input type="hidden" name="permanent_hidden"
                                                            value="{{ $lims_product_data->permanent }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4" id="start_date_courtesy">
                                                <div class="form-group">
                                                    <label>{{ trans('file.initial date') }}</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text"><i
                                                                    class="dripicons-calendar"></i></div>
                                                        </div>
                                                        <input type="text" required name="starting_date_courtesy"
                                                            id="starting_date_courtesy" class="form-control"
                                                            value="{{ $lims_product_data->starting_date_courtesy }}" />
                                                    </div>
                                                    <span class="validation-msg"></span>
                                                </div>
                                            </div>
                                            <div class="col-md-4" id="last_date_courtesy">
                                                <div class="form-group">
                                                    <label>{{ trans('file.final date') }}</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text"><i
                                                                    class="dripicons-calendar"></i></div>
                                                        </div>
                                                        <input type="text" required name="ending_date_courtesy"
                                                            id="ending_date_courtesy" class="form-control"
                                                            value="{{ $lims_product_data->ending_date_courtesy }}" />
                                                    </div>
                                                    <span class="validation-msg"></span>
                                                </div>
                                            </div>
                                            <div class="col-md-4" id="price_courtesy">
                                                <div class="form-group">
                                                    <label>{{ trans('file.courtesy clearance price') }}</label>
                                                    <input type="number" name="courtesy_clearance_price"
                                                        value="{{ $lims_product_data->courtesy_clearance_price }}"
                                                        required class="form-control" step="any" />
                                                    <span class="validation-msg"></span>
                                                </div>
                                            </div>
                                    ...
                                    <div id="courtesy-products-div" class="col-md-9 mb-1">
                                        <label>{{ trans('file.add_product') }}</label>
                                        <div class="search-box input-group mb-3">
                                            <button class="btn btn-secondary"><i class="fa fa-barcode"></i></button>
                                            <input type="text" name="product_code_name_courtesy"
                                                id="lims_productcodeSearch_courtesy"
                                                placeholder="Please type product code and select..."
                                                class="form-control" />
                                        </div>
                                        <label>{{ trans('file.associated products') }}</label>
                                        <div class="table-responsive">
                                            <table id="table-courtesy" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        <th>{{ trans('file.product') }}</th>
    ...
    <script type="text/javascript">
        ...
        if ($("input[name='type_hidden']").val() == "digital") {
            ...
            $("#basicservice").hide();
            //calculate_price();
        } else if ($("input[name='type_hidden']").val() == "producto_terminado") {
            ...
            hide();
            $("#cost").show();
            $("input[name='cost']").prop('readonly', true);
            $("#basicservice").hide();
            calculate_cost()
        }
        ...
        $('select[name=account_id]').val(account_id);
        ...
        $('select[name="type"]').on('change', function() {
            ...
            if ($(this).val() == 'producto_terminado') {
                $("input[name='cost']").prop('required', false);
                $("select[name='unit_id']").prop('required', false);
                hide();
                $("#cost").show();
        ...
        $('input[name="saveprice"]').on('change', function() {
            if ($(this).is(':checked')) {
                $('.unit_price').prop('readOnly', false);
            } else {
                swal("Advertencia",
                    "Al deshabilitar guardar precios se restablecera los precios originales en Precio al guardar el producto.",
                    "warning");
        ...
        if ($("input[name='type_hidden']").val() == "producto_terminado")
            changetype_pro('pro_terminado');
        else
            changetype_pro('combo');
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $(".product-id").each(function() {
                            if ($(this).val() == data[4]) {
                                swal("Error", "No se permite la entrada duplicada!",
                                    "error");
                                flag = 0;
                            }
                        });
        ...
        var lims_productcodeSearchInsumo = $('#lims_productcodeSearchInsumo');

        lims_productcodeSearchInsumo.autocomplete({
            source: function(request, response) {
                var matcher = new RegExp(".?" + $.ui.autocomplete.escapeRegex(request.term), "i");
                response($.grep(lims_product_code, function(item) {
                    return matcher.test(item);
            ...
            select: function(event, ui) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("input[name='product_code_name_insumo']").val('');
                        if (flag) {
                            var newRow = $("<tr>");
                            var cols = '';
                            cols += '<td>' + data[0] + ' [' + data[1] + ']</td>';
                            ...
                            newRow.append(cols);
                            $("#myTableIns tbody").append(newRow);
                            calculate_cost();
                        }
                    }
                });
        ...
        function changetype_pro(type) {
            if (type == "combo") {
                $.get('../getproducts/combo', function(data) {
                    lims_product_code = data;
                });
            } else if (type == "pro_terminado") {
                $.get('../getproducts/pro_terminado', function(data) {
                    lims_product_code = data;
                });
            }
        }
        ...
        $("#myTableIns").on('input', '.qty , .unit_price', function() {
            calculate_cost();
        });
        ...
        $("#myTableIns tbody").on("click", ".ibtnDel", function(event) {
            $(this).closest("tr").remove();
            calculate_cost();
        });
        ...
        function calculate_price() {
            ...
            $(".qty").each(function() {
                ...
                quantity = $(this).val();
                unit_price = $('#myTable tbody tr:nth-child(' + (rowindex + 1) + ') .unit_price').val();
        ...
        function calculate_cost() {
            ...
            $(".qty").each(function() {
                rowindex = $(this).closest('tr').index();
                quantity = $(this).val();
                unit_cost = $('#myTableIns tbody tr:nth-child(' + (rowindex + 1) + ') .unit_price').val();
        ...
        //COURTESY
        $("#permanent").hide(300);
        $("#start_date_courtesy").hide(300);
        $("#last_date_courtesy").hide(300);
        $("#courtesy-products-div").hide();
        $("#price_courtesy").hide();

        $("input[name='cost']").on('change', function() {
            $("input[name='courtesy_clearance_price']").val($(this).val());
        });

        $("select[name='permanent']").val($("input[name='permanent_hidden']").val());
        $('.selectpicker').selectpicker('refresh');

        var courtesy = $("input[name='courtesy_hidden']").val();
        if (courtesy == 'TRUE') {
            $("input[name='courtesy']").prop('checked', true);
            if ($("select[name='permanent']").val() == 'FALSE') {
                $("#starting_date_courtesy").val($.datepicker.formatDate('dd-mm-yy', new Date($("#starting_date_courtesy")
                    .val() + "T00:00:00")));
                $("#ending_date_courtesy").val($.datepicker.formatDate('dd-mm-yy', new Date($("#ending_date_courtesy")
                    .val() + "T00:00:00")));
            } else {
                $("#starting_date_courtesy").val($.datepicker.formatDate('dd-mm-yy', new Date()));
            }
            $("#permanent").show(300);
            showOrHideFields($("select[name='permanent']").val());
            $("#courtesy-products-div").show(300);
            $("#price_courtesy").show(300);
        } else {
            $("#permanent").hide(300);
            $("#start_date_courtesy").hide(300);
            $("#last_date_courtesy").hide(300);
            $("#courtesy-products-div").hide(300);
            $("#price_courtesy").hide(300);
        }

        $.get('../getproducts/all', function(data) {
            lims_product_all_code = data;
        });

        var starting_date_courtesy = $('#starting_date_courtesy');

        starting_date_courtesy.datepicker({
            format: "dd-mm-yyyy",
            startDate: "<?php echo date('d-m-Y'); ?>",
            autoclose: true,
            todayHighlight: true
        ...
        var ending_date_courtesy = $('#ending_date_courtesy');
        ending_date_courtesy.datepicker({
            format: "dd-mm-yyyy",
            startDate: "<?php echo date('d-m-Y'); ?>",
            autoclose: true,
            todayHighlight: true
        ...
        function showOrHideFields(value) {
            if (value == 'TRUE') {
                ...
                $("#start_date_courtesy").show(300);
                $("#last_date_courtesy").show(300);
            }
        }

        $("select[name='permanent']").on('change', function() {
            const value = $(this).val();
            console.log("value permanent", value)
            showOrHideFields(value)
        });

        $("#courtesy").on("change", function() {
            if ($(this).is(':checked')) {
                $("#starting_date_courtesy").val($.datepicker.formatDate('dd-mm-yy', new Date()));
                $("#permanent").show(300);
                showOrHideFields($("select[name='permanent']").val());
        ...
        const products_courtesy = <?php echo json_encode($lims_product_asocciated); ?>;

        products_courtesy.forEach(function(item) {
            var newRow = $("<tr>");
            var cols = '';
            cols += '<td>' + item.name + '</td>';
            cols += '<td>' + item.code + '</td>';
            cols += '<td>' + item.price + '</td>';
            cols += '<td><button type="button" class="btnDelProductCourtesy btn btn-sm btn-danger">X</button></td>';
            cols += '<input type="hidden" class="product-id-courtesy" name="product_id_courtesy[]" value="' + item
                .id + '"/>';

            newRow.append(cols);
            $("#table-courtesy tbody").append(newRow);
        });

        const lims_productcodeSearchCourtesy = $('#lims_productcodeSearch_courtesy');

        lims_productcodeSearchCourtesy.autocomplete({
            source: function(request, response) {
                var matcher = new RegExp(".?" + $.ui.autocomplete.escapeRegex(request.term), "i");
                response($.grep(lims_product_all_code, function(item) {
                    return matcher.test(item);
                }));
            },
            select: function(event, ui) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        var flag = 1;
                        $(".product-id-courtesy").each(function() {
                            if ($(this).val() == data[4]) {
                                swal("Informacion", "No se permite la entrada duplicada!",
                                    "info");
                                flag = 0;
                            }
                        });
                        $("input[name='product_code_name_courtesy']").val('');
                        if (flag) {
                            var newRow = $("<tr>");
                            var cols = '';
                            cols += '<td>' + data[0] + '</td>';
                            ...
                            cols += '<td>' + data[3] + '</td>';
                            cols +=
                                '<td><button type="button" class="btnDelProductCourtesy btn btn-sm btn-danger">X</button></td>';
                            cols +=
                                '<input type="hidden" class="product-id-courtesy" name="product_id_courtesy[]" value="' +
                                data[4] + '"/>';
        ...
        //delete product
        $("#table-courtesy tbody").on("click", ".btnDelProductCourtesy", function(event) {
            $(this).closest("tr").remove();
        });
        ...
        function validate() {
            ...
            if ($("#type").val() == 'combo') {
                ...
                if (rownumber < 0) {
                    swal("Informacion", "Por favor, agregar un producto en la tabla!", "info");
                    return false;
                }
            }
            $("input[name='price']").prop('disabled', false);
            if ($('#courtesy').is(':checked') && $(".product-id-courtesy").length == 0) {
                swal("Informacion", "Debe aegregar al menos 1 producto asociados!", "info");
                return false;
            }
            return true;
        }
    ...
    @php
        $categoryItems = $lims_category_list->map(function($cat) {
            return [
                'id' => $cat->id,
                'code' => str_pad($cat->id, 4, '0', STR_PAD_LEFT),
                'text' => $cat->name,
                'name' => $cat->name
            ];
        });
    ...
    @include('partials.search-select-modal', [
        'modalId' => 'categorySearchModal',
        'title' => 'Buscar y Seleccionar Categoría',
        'searchPlaceholder' => 'Buscar por código o nombre...',
        'columns' => ['Código', 'Nombre'],
        'items' => $categoryItems,
        'targetSelectId' => 'category_id',
        'targetInputId' => 'category_display'
    ])
@endsection
