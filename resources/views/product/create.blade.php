                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="code" minlength="1" class="form-control"
                                    ...
                                    @include('product.partials-actividad-productos-servicios-create')
                                    {{-- formulario para homologación siat --}}
                                            ...
                                            <div class="col-md-4 form-group">
                                                ...
                                                <div class="input-group">
                                                    <select required class="form-control selectpicker" name="unit_id">
                                                        <option value="" disabled selected>Seleccionar unidad del
                                                            producto...
                                                        </option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price_a" class="form-control" step="any"
                                                value="0">
                                            <span class="validation-msg"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price_b" class="form-control" step="any"
                                                value="0">
                                            <span class="validation-msg"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price_c" class="form-control" step="any"
                                                value="0">
                                            <span class="validation-msg"></span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-4" id="price_courtesy">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="courtesy_clearance_price" required
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('select[name="type"]').on('change', function() {
                ...
                } else if ($(this).val() == 'producto_terminado') {
                    $("input[name='cost']").prop('required', false);
                    $("select[name='unit_id']").prop('required', false);
                    hide();
                    $("#pro_terminado").show(300);
                    $("#combo").hide(300);
                    $("#commission").hide(300);
                    $("#cost").show(300);
                    $("input[name='price']").prop('disabled', false);
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $(".product-id").each(function() {
                                if ($(this).val() == data[4]) {
                                    swal("Error",
                                        "No se permite la entrada duplicada!",
                                        "error");
                                    flag = 0;
                                }
                            });
            ...
            function calculate_cost() {
                ...
                $(".qty").each(function() {
                    rowindex = $(this).closest('tr').index();
                    quantity = $(this).val();
                    unit_cost = $('#myTableIns tbody tr:nth-child(' + (rowindex + 1) + ') .unit_price')
                        .val();
            ...
            $("input[name='variant']").on("input", function() {
                if ($("#code").val() == '') {
                    ...
                    cols += '<td><input type="text" class="form-control" name="variant_name[]" value="' +
                        variant_name +
                        '" /></td>';
                    cols += '<td><input type="text" class="form-control" name="item_code[]" value="' +
                        item_code +
                        '" /></td>';
                    cols +=
            ...
            jQuery.validator.setDefaults({
                ...
                highlight: function(element) {
                    $(element).closest('div.form-group').removeClass('has-success').addClass(
                        'has-error');
                },
                unhighlight: function(element, errorClass, validClass) {
                    $(element).closest('div.form-group').removeClass('has-error').addClass(
                        'has-success');
            ...
            function validate() {
                ...
                if ($("#type").val() == 'combo') {
                    ...
                    if (rownumber < 0) {
                        alert("Por favor ingrese un producto en la tabla!")
                        return false;
                    }
                }
                ...
                if ($('#courtesy').is(':checked') && $(".product-id-courtesy").length == 0) {
                    alert('Debe agregar al menos 1 productos asociados')
                    return false;
                }
                return true;
            }
