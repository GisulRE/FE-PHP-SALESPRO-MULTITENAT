                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mt-4">
                                    <label>Habilitar {{trans('file.Pre Sale')}}</label>
                                    <input type="checkbox" name="check_presale" />
                                </div>
                                <div class="form-group" id="warehouse_presale">
                                    <label>{{trans('file.Warehouse')}} *</label>
                                    <select name="warehouse_id_sale" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Warehouse...">
                                        @foreach($lims_warehouse_list as $warehouse)
                                        <option value="{{$warehouse->id}}">{{$warehouse->name}}</option>
                                        @endforeach
                                    </select>
...
<script type="text/javascript">
    ...
    $('input[name="check_presale"]').on('change', function() {
        if($(this).is(':checked')){
            $('#warehouse_presale').show(400);
            $('select[name="warehouse_id_sale"]').prop('required',true);
        }
        else{
            $('#warehouse_presale').hide(400);
            $('select[name="warehouse_id_sale"]').prop('required',false);
        }
    });
</script>
@endsection