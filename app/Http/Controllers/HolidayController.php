...
class HolidayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Holiday::create($data);
        return redirect()->back()->with('message', "Vacación creado con éxito");
    }
    ...
    public function approveHoliday($id)
    {
        ...
        try {
            Mail::send('mail.holiday_approve', $mail_data, function ($message) use ($mail_data) {
                $message->to($mail_data['email'])->subject('Vacación Aprobada');
            });
        } catch (\Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->back()->with('message', "Vaciones Actualizado con éxito");
    }
    ...
    public function deleteBySelection(Request $request)
    {
        ...
        return 'Vacaciones eliminados con éxito!';
    }

    public function destroy($id)
    {
        if (Holiday::find($id)->delete())
            return redirect()->back()->with('not_permitted', "Vacación eliminado con éxito");
        else
            return redirect()->back()->with('not_permitted', "Falló al eliminar Vacación, Intente de nuevo");
